class QuestionAnswer {
  var tanong = [
    ...
    //FOR QUIZ3 Behavioral QUESTION
    ["qqq1", "qqq2"],

    //FOR QUIZ4 CAPITAL QUESTION
    ["qqqq1", "qqqq2"]
  ];
  var sagot = [
    //FOR QUIZ1 FINANCIAL CHOICES
    [
      [
        "A.  Money Tracker",
        "B. Financial Wallet",
    ...
    //FOR QUIZ3 BEHAVIORAL CHOICES
    [
      ["qqq1s1", "qqq1s2"],
      ["qqq2s1", "qqq2s2"],
    ],

    //FOR QUIZ4 CAPITAL CHOICES
    [
      ["qqqq1s1", "qqqq1s2"],
      ["qqqq2s1", "qqqq2s2"],
    ]
  ...
  var tama = [
    ...
    //FOR QUIZ3 BEHAVIORAL ANSWERS
    ["qqq1s2", "qqq2s2"],

    //FOR QUIZ4 CAPITAL ANSWERS
    ["qqqq1s2", "qqqq2s1"]
  ];
}
